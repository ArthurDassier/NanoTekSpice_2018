...
Test(tests_Component_4001, test_check_construction)
{
    Component_4001 test("test");

    cr_assert_eq(test.getName(), "test");
    cr_assert_eq(test.getType(), "4001");
}
...
Test(tests_Component_4001, test_check_output_return_true)
{
    Component_4001 test("test");
...
Test(tests_Component_4001, test_check_input_return_false)
{
    Component_4001 test("test");
...
Test(tests_Component_4001, test_check_output_return_false)
{
    Component_4001 test("test");
