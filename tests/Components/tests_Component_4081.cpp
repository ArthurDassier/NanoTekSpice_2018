...
Test(tests_Component_4081, test_check_construction)
{
    Component_4081 test("test");

    cr_assert_eq(test.getName(), "test");
    cr_assert_eq(test.getType(), "4081");
}

Test(tests_Component_4081, test_check_input_return_true)
{
    Component_4081 test("test");
...
Test(tests_Component_4081, test_check_output_return_true)
{
    Component_4081 test("test");
...
Test(tests_Component_4081, test_check_input_return_false)
{
    Component_4081 test("test");
...
Test(tests_Component_4081, test_check_output_return_false)
{
    Component_4081 test("test");
...
Test(tests_Component_4081, test_truth_table)
{
    Component_4081 test("test");
    True tru("tru");
    False fals("fals");
    ...
    test.setLink(5, undef, 1);
    test.setLink(6, tru, 1);
    cr_assert_eq(test.compute(4), nts::UNDEFINED);
    test.setLink(5, undef, 1);
