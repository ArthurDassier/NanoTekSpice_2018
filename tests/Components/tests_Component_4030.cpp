...
Test(tests_Component_4030, test_check_construction)
{
    Component_4030 test("test");

    cr_assert_eq(test.getName(), "test");
    cr_assert_eq(test.getType(), "4030");
}

Test(tests_Component_4030, test_check_input_return_true)
{
    Component_4030 test("test");
...
Test(tests_Component_4030, test_check_output_return_true)
{
    Component_4030 test("test");
...
Test(tests_Component_4030, test_check_input_return_false)
{
    Component_4030 test("test");
...
Test(tests_Component_4030, test_check_output_return_false)
{
    Component_4030 test("test");
...
Test(tests_Component_4030, test_truth_table)
{
    Component_4030 test("test");
    True tru("tru");
    False fals("fals");
